...
function DobPicker() {
    ...
    return (
        <div className="dob-picker">
            <select defaultValue="" id="dob-picker__month" className="signup__form__input input-select" onChange={(e) => {
            ...
            <select defaultValue="" id="dob-picker__day" className="signup__form__input input-select" >
                <option value="" disabled hidden>Day</option>
                {days.map(day => <option key={day}>{day}</option>)}
            </select>
            <select defaultValue="" id="dob-picker__year" className="signup__form__input input-select" onChange={(e) => {
